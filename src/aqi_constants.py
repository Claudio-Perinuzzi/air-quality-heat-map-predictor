#############################################################################################
# File of Constants That Include:
#   NYC Annual and Seasonal Min and Max AQI Values
#   Past and Future Seasonal Time Frames
#   Past Annual Time Frames
#   Mapping Between The Borough CD/ID To The Location The Testing Was Performed
#   Predefined HTMLs For Rendering Maps Which Include:
#       - A True NYC HTML Legend
#       - A Interpolated NYC HTML Legend
#############################################################################################


# Respective average Min and Max values annually and seasonally.
...
# Used for calculating annual aqi averages
ANNUAL_AQI_AVERAGE = (
...
# Used for calculating seasonal aqi averages
...
ANNUAL_SCROLL_BAR = (
    ...
    'Annual Average 2018', 'Annual Average 2019', 'Annual Average 2020',
    'Annual Average 2021', 'Annual Average 2022', 
    'Annual Average 2023 (Future)',
    'Annual Average 2024 (Future)', 
    'Annual Average 2025 (Future)',
    'Annual Average 2026 (Future)',
    'Annual Average 2027 (Future)',
    'Annual Average 2028 (Future)',
)
...
# Used for calculating winter AQI averages
WINTER_SEASONS = ( 
    'Winter 2008-09', 
    'Winter 2009-10', 
    'Winter 2010-11', 
...
# Used for calculating summer AQI averages
SUMMER_SEASONS = ( 
    'Summer 2009',
    'Summer 2010',
    'Summer 2011',
...
# Used for generating future HTML maps for the seasons
FUTURE_SEASONS = (
...
# Used to map the CD starting number to the borough name
CD_TO_BORO = {
    100: 'Manhattan',
    200: 'Bronx',
    300: 'Brooklyn',
...
'''
Mapping used to group districts from the dataset to the corresponding borough CD.
These districts are used to calculate the AQI averages for the given borough CD.
